# Web Studio — GOIT Markup Homework 06

Live demo 👉 https://yurii-voronich.github.io/goit-markup-hw-06/
...
- **JS** (Modal logic, mobile menu, scroll button)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yurii-voronich/goit-markup-hw-06.git
   ```
2. **Open with browser**
   Open index.html in your favorite web browser

(Note: No build tools are used — plain HTML/CSS.)
